...
impl ConstZero for DInterval {
    const ZERO: Self = Self::ZERO;
}
impl ConstOne for DInterval {
    const ONE: Self = Self::ONE;
}
impl Zero for DInterval {
    fn zero() -> Self {
        Self::ZERO
    }
    fn is_zero(&self) -> bool {
...
impl FromPrimitive for DInterval {
    impl_from_primitive!(from_i64, i64);
    impl_from_primitive!(from_u64, u64);
    impl_from_primitive!(from_isize, isize);
    impl_from_primitive!(from_i8, i8);
...
impl ToPrimitive for DInterval {
    impl_to_primitive!(to_i64, i64);
    impl_to_primitive!(to_u64, u64);
    impl_to_primitive!(to_isize, isize);
    impl_to_primitive!(to_i8, i8);
...
impl Float for DInterval {
    ...
    fn is_normal(self) -> bool {
        Float::is_normal(self.i)
    }

    fn classify(self) -> FpCategory {
        Float::classify(self.i)
    }
    ...
    fn is_sign_positive(self) -> bool {
        Float::is_sign_positive(self.i)
    }

    fn is_sign_negative(self) -> bool {
        Float::is_sign_negative(self.i)
    }
